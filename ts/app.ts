...
const app: ng.IModule = ng.module( "youTubeCommentator", [ "ngRoute", "ngCookies", "ngSanitize", "infinite-scroll", "monospaced.elastic" ] );
...
ng.module('infinite-scroll').value('THROTTLE_MILLISECONDS', 500);

app.value( "authorizationScopes", scopes);

function initiateApp() {
    ng.bootstrap( document, ["youTubeCommentator"] );
}
